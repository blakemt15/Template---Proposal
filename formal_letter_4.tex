...
\address{
\includegraphics[width=1in]{stone.png}% Include the logo of your institution
...
\Large\hspace{1.5in}STONEWALL \hfill ~\\[0.05in] % First line of institution name, adjust hspace if your logo is wide
\hspace{1.5in}ENGINEERING CONSULTING\hfill \normalsize % Second line of institution name, adjust hspace if your logo is wide
